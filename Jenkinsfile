pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://3.85.185.106:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/2300033618-charan/fullstackapp.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://3.85.185.106:9090/springapp1"
            echo "✅ Frontend deployed: http://3.85.185.106:9090/frontapp1"
        }
        failure {
